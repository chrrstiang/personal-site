    ...
    return(
        <div className="flex flex-col items-center w-full m-10 sm:ml-0">
            ...
            <div className="flex flex-col md:w-1/2 items-center md:items-start m-5 gap-5">
                ...
                <Typography className="text-2xl w-10/12">{projectDescription}</Typography>
                <button className="text-xl text-zinc-50 bg-blue-700 rounded-md w-8/12 p-1 hover:bg-blue-400">Read more here</button>
                </div>
            </div>
        </div>
    )
